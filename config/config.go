...
// ConvertAs2_1 will convert a golang struct representing a Container Linux
...
// ConvertAs2_1 also accepts a platform string, which can either be one of the
...
func ConvertAs2_1(in types.Config, p string, ast astnode.AstNode) (ignTypes.Config, report.Report) {
	...
	return types.ConvertAs2_1(in, p, ast)
}
